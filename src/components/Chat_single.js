                    ...
                    {chat.map((val, key) => {
                      return (
                        ...
                        <div className={ val.isSentByMe === true ? "w-full flex justify-end my-1" : "w-full flex justify-start my-1" }>
                            <div className={ val.isSentByMe === true ? "max-w-[60%] bg-[#A52729] text-[#ffffffe6]  rounded-md text-[14px] flex shadow-md" : "max-w-[60%] bg-[white] text-[#111b21] h- text-[14px] rounded-md flex shadow-md" }>
